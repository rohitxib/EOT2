//
//  AuditCoustomField.swift
//  EyeOnTask
//
//  Created by Jugal Shaktawat on 02/06/21.
//  Copyright © 2021 Hemant. All rights reserved.
//

import UIKit

class AuditCoustomField: UIViewController , UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate , UITextViewDelegate{
      ...
      //  var fff : arrOfShowDatas?
        ...
        //        let idx = arrOFShowTabForm.index(where: { $0.frmId ==  objOFTestVC?.frmId })
                ...
                let customFormVC = self.storyboard?.instantiateViewController(withIdentifier: "AuditCoustomField") as! AuditCoustomField
...
//                }
            ...
            */
                  ...
                  func getQuestionsByParentId(patmid:String){
                      ...
                      // param.usrId = getUserDetails()?.usrId
                       param.audId = self.objOfUserJobList.audId
    ...
    //
        ...
        extension String {
            func hieight1(withConstrainedWidth width: CGFloat, font: UIFont) -> CGFloat {
            ...
            func wiidth2(withConstraintedHeight height: CGFloat, font: UIFont) -> CGFloat {
