...
class ClientChatVC:  UIViewController , UITextViewDelegate, OptionViewDelegate {
...
//        }
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(NotificationResive), name: Notification.Name ("ClientChatVC"), object: nil)
