...
class EditContactVC: UIViewController , UITextFieldDelegate ,OptionViewDelegate{
    ...
    @IBOutlet weak var txtFld_LinkSite: FloatLabelTextField!
    ...
    func setLocalization() -> Void {
        ...
        txtFld_LinkSite.placeholder = "\(LanguageKey.link_site)"
    }
    ...
    func setUpMethod(){
        ...
        fieldOne.text = objOFEditContactVC?.extraField1
        fieldTwo.text = objOFEditContactVC?.extraField2
        fieldThree.text = objOFEditContactVC?.extraField3
        fieldFour.text = objOFEditContactVC?.extraField4
        txtFld_Notes.text = objOFEditContactVC?.notes
        ...
        txtFld_LinkSite.text = objOFEditContactVC?.snm
        ...
        if objOFEditContactVC?.isactive == "1" {
                ...
                //                  self.txtField_LinkSite.text = cltAllSieList?.snm
                            ...
                            for dic in arrOfShow {
                                if (paramsContect.siteId?.contains(dic.siteId!))!{
                                    ...
                                    if strTitle == ""{
                                                                   ...
                                                                   DispatchQueue.main.async {
                                                                       self.txtFld_LinkSite.text = strTitle
                                                                   }
                           ...
                           // self.txtField_LinkSite.text  = arrOfShow[indexPath.row].snm
                                // paramsContect.siteId = arrOfShow[indexPath.row].siteId
                                 paramsContect.snm = self.txtFld_LinkSite.text
...
//    //                  self.txtField_LinkSite.text = cltAllSieList?.snm
//
//                self.txtFld_LinkSite.text  = arrOfShow[indexPath.row].snm
//                               self.removeOptionalView()
//                      param.siteId = arrOfShow[indexPath.row].siteId
//                      param.snm = arrOfShow[indexPath.row].snm
//
//                      self.removeOptionalView()
             }
    ...
    @IBAction func dropDwbBtn(_ sender: Any) {
         self.openDwopDown( txtField: self.txtFld_LinkSite, arr: arrOfShow)
    }
...
//        }
    ...
    func updateUserContact(){
        ...
        param.snm = txtFld_LinkSite.text?.trimmingCharacters(in: .whitespacesAndNewlines)
        ...
        param.notes = trimString(string:  txtFld_Notes.text!)
      ...
      //  param.siteId = objOFEditContactVC!.siteId as! [String]
      //  param.snm = objOFEditContactVC!.snm
        DatabaseClass.shared.saveEntity(callback: { isSuccess in
            ...
            DatabaseClass.shared.saveOfflineContect(service: Service.updateClientContact, param: param)
