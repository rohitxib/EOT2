...
open class BarcodeScannerViewController: UIViewController {
  ...
  public weak var dismissalDelegate: BarcodeScannerDismissalDelegate?
    ...
    var auditId : String?
    var equipId : String?
    var isScanBarcodeLinkEquip = false
  ...
  open override func viewDidLoad() {
    ...
    messageViewController.barcode = barcode
    messageViewController.cltId = cltId
    messageViewController.arrOfEquipment = arrOfEquipment
    messageViewController.auditId = auditId
