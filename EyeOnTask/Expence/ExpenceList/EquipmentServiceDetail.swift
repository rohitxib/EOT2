//
//  EquipmentServiceDetail.swift
//  EyeOnTask
//
//  Created by Jugal Shaktawat on 18/03/21.
...
class EquipmentServiceDetail: UIViewController , MFMailComposeViewControllerDelegate, UITableViewDelegate, UITableViewDataSource {
    
    var serviceDetail : AllEquipmtser? 
    ...
    @IBOutlet weak var tableView: UITableView!
        ...
        var objOfUserJobListInDetail : ServiceDetailData? /////////////////////////////////// new add
...
//              self.navigationItem.rightBarButtonItem = leftButton
    ...
    //        let button = UIBarButtonItem(image: UIImage(named: "back-arrow"), style: .plain, target: self, action: #selector(DetailJobVC.onClcikBack1))
    //
    //                   self.navigationItem.rightBarButtonItem  = button
        ...
        func setLocalization() -> Void {
            ...
            listItem.text = LanguageKey.list_item
        }
...
//        }
        ...
        func getQuestionsByParentId(patmid:String){
            ...
            param.frmId = patmid
            // param.usrId = getUserDetails()?.usrId
            param.jobId = serviceDetail?.audId //self.objOfUserJobListInDetail?.jobId
        ...
        func getAuditDetail(){
            ...
            param.jobId = serviceDetail?.audId
        ...
        //======================================================
                   ...
                   func getItemListRecord() {
                      ...
                      // showLoader()
                       let param = Params()
                       param.jobId = serviceDetail?.audId  //objOfUserJobListInDetail?.jobId
                      // param.invId = ""
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return itemListDetail.count
         ...
         func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            cell.itemAmount.text = customFormDetals.inm //"asd"
