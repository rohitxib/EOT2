//
//  AttechementRemark.swift
//  EyeOnTask
//
//  Created by Jugal Shaktawat on 17/07/21.
//  Copyright © 2021 Hemant. All rights reserved.
//

import UIKit

class AttechementRemark: UIViewController,UICollectionViewDelegate, UICollectionViewDataSource {

    @IBOutlet weak var collactionVw: UICollectionView!
